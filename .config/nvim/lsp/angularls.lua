...
--- vim.lsp.config('angularls', {
  ...
  local function collect_node_modules(root_dir)
    ...
    -- Walk up from root_dir to find node_modules (handles hoisted/monorepo layouts)
    local dir = root_dir
    while dir and dir ~= fs.dirname(dir) do
      local candidate = fs.joinpath(dir, 'node_modules')
